...
**Proposed Sponsor:** IntellectEU (Jonathan Mayeur — Head of Product, Canton Board Member)
**Funding Requested:** £34,380 equivalent in Canton Coin
**Duration:** 6 calendar weeks (3 Agile sprints)
**Date:** March 2026
...
This proposal requests funding **exclusively for the Canton-specific on-ledger build**. Stratalink's off-chain computation infrastructure (Layers 1–3) and Canton Adapter (Layer 4) are funded independently by Stratalink. The grant covers IntellectEU's development of the Daml contract layer and supporting infrastructure.
...
| ADGM Regulatory Pilot — live across fourteen venues | Active |

**Co-investment:** Stratalink contributes approximately £45,300 in internal engineering, management, and infrastructure costs to the Canton integration — in addition to the grant-funded IntellectEU development. Total project investment is approximately £80,000, of which the grant covers 43%.
...
| **Validator Node** | **Canton Network** | **Stratalink's on-network presence, deployed via IntellectEU Catalyst — GRANT-FUNDED SCOPE** |
...
|---|---|---|---|---|
| **M1: Foundation & Orchestrator** | Oracle Orchestrator contract live on Canton devnet. Compliance Officer onboarded. Public key management operational. AttestationRequest choice functional. | Demonstrated on devnet: Consumer can submit an AttestationRequest via the Orchestrator. Compliance Officer is visible as observer. | End of Sprint 1 (Week 2) | £11,460 (33%) |
| **M2: Attestation & Verification** | Attestation contracts creating on acceptance. TTL enforcement operational. Signature verification functional. Consumer verification choice working. | Demonstrated on devnet: Full lifecycle from request to published attestation. Consumer can verify signature and STALE status. CO can read attestation data. | End of Sprint 2 (Week 4) | £11,460 (33%) |
| **M3: Integration & Handover** | End-to-end integration test suite complete. Technical handover documentation delivered. All acceptance criteria met per user stories. | Full integration test report. Documentation review complete. Stratalink's Canton Adapter successfully publishing live attestations to devnet. | End of Sprint 3 (Week 6) | £11,460 (34%) |

**Total grant funding:** £34,380 equivalent in Canton Coin, released across three milestones upon demonstrated delivery.

**Risk mitigation:** The Agile sprint methodology provides built-in flexibility to adjust scope within sprints if technical issues arise. IntellectEU's Delivery Manager (25% allocation, 60 hours) is specifically tasked with unblocking issues, managing dependencies with Stratalink's Canton Adapter team, and ensuring sprint velocity stays on track. IntellectEU's prior experience delivering Daml contracts on Canton via Catalyst — including for clients such as Broadridge and Deutsche Börse — reduces integration risk significantly.
...
The following acceptance criteria define specific, testable conditions for each deliverable. These are derived from IntellectEU's detailed user stories.
...
| Item | Detail |
|---|---|
| **Total Grant Requested** | £34,380 equivalent in Canton Coin |
| **Grant Covers** | IntellectEU Daml contract development, integration testing, and technical documentation (6 weeks / 3 sprints / 315 hours) |
...
| **Stratalink Co-Investment** | Approximately £45,300 in internal engineering, management, and infrastructure costs |
| **Total Project Value** | Approximately £80,000 (£34,380 grant + £45,300 Stratalink) |
| **Duration** | 6 calendar weeks (3 Agile sprints with 2-week cadence) |
| **Funding Release** | Three equal milestone payments of £11,460 upon demonstrated delivery |
| **Denomination** | Canton Coin at prevailing rate at each milestone |
| **Proposed Sponsor** | IntellectEU (Canton Foundation member, Jonathan — Head of Product) |
...
|---|---|---|
| **Abu Dhabi / MENA** | Lead market. Stratalink has an active regulatory pilot and established presence. Canton ecosystem has strong MENA engagement (Ripple Prime, institutional tokenisation activity). | ADGM RegLab active |
| **Europe / UK** | Second market. Rob McDermott's institutional network (Goldman Sachs, Deutsche Bank). MiFID II expertise provides credibility with European institutional buyers. FCA dialogue underway. | FCA engagement active |
...
**2. IntellectEU ecosystem (Secondary — Phase 1–2).** IntellectEU's client base includes institutional blockchain adopters across Europe and the Middle East. As the technical delivery partner, IntellectEU can introduce PoLi to clients already using Catalyst for Canton deployments.
...
| Technical architecture validated | IntellectEU's Daml leads conducted technical deep-dive. Scenario 2 (on-demand) selected as MVP. Detailed user stories with acceptance criteria produced. |
| Commercial proposal received | IntellectEU has delivered a formal proposal: £34,380 for 6 weeks / 3 Agile sprints. Scope, team, rates, and deliverables specified. |
| Regulatory engagement active | ADGM regulatory pilot live. FCA dialogue underway. |
...
| Team credibility | CEO with 27 years institutional finance (Goldman Sachs, Deutsche Bank). IntellectEU as Canton's leading Daml partner. |
...
- **IntellectEU: maintenance available under separate agreement.** IntellectEU's grant-funded engagement covers development through Milestone 3 (integration testing and handover). Post-delivery Daml contract maintenance, performance optimisation, and feature development for Phase 2 are available under a separate support agreement to be negotiated with IntellectEU. This ensures continuity of Daml expertise without over-committing grant-funded resources.
...
| **Technical Partner** | Vitalii Shatula, Delivery Manager, IntellectEU |
| **Commercial Partner** | Bruno Almeida, Head of Digital Assets and AI, IntellectEU |
