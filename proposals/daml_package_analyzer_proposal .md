...
## 2. Implementation Mechanics
  ...
  - Inspect the `.dar` file and identify all the packages used  
  - For every package, identify every location where the code exercises choices defined on a template or interface from another package.  
  ...
  - For each such interaction, report:  
   ...
   2. the exact line number (and column range where available)  
   3. the calling package and package version  
   4. the referenced package/interface and the version  
   5. the template/interface and choice involved  
   6. If it is a non-consuming or consuming choice  
...
## 3. Architectural Alignment
   ...
   In addition, the tool will be added to [`dpm`](https://github.com/digital-asset/dpm), to make the usage of the tool even easier for Daml engineers.
