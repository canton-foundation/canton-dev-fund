...
The diagram below illustrates the end-to-end data flow from RedStone's signing infrastructure through CantonÕs contract layer to the privacy-scoped consumption layer, including the fee distribution path that closes the data economics loop.
