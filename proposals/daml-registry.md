...
### 3.1.1. Package version discovery
...
### 3.1.3. Dependency resolution algorithm
...
### 3.1.5. The lockfile: `daml-lock.yaml`
...
### 3.2.1. Parallel tarball download
...
### 3.3.1. Topological compilation order
...
### 3.3.2. Build orchestration flow diagram
...
The project is organized into six milestones that map to the system components and operational phases described in this proposal. Each milestone produces a demonstrable deliverable and has clear acceptance criteria.

## Milestone 1: Core Registry Service

**Duration:** Sprints 1 | **Effort:** 240 man-hours | **Funding** 145 000 CC
...
**Acceptance criteria:** An author can authenticate, publish a Daml package via API, and the resulting index file and tarball are accessible from blob storage/CDN.

---

## Milestone 2: CLI Resolve Phase & Lockfile

**Duration:** Sprint 2 | **Effort:** 280 man-hours | **Funding** 170 000 CC
...
**Acceptance criteria:** Running `dpm add <pkg>` resolves the full transitive dependency tree, produces a correct `daml-lock.yaml`, and subsequent runs skip resolution using the lockfile.

---

## Milestone 3: CLI Fetch & Build Phases

**Duration:** Sprint 3 | **Effort:** 280 man-hours | **Funding** 170 000 CC
...
**Acceptance criteria:** A cold `dpm build` on a project with a multi-level dependency tree fetches all tarballs, compiles in correct topological order, produces valid `.dar` outputs, and a subsequent build hits cache with zero network requests.

---

## Milestone 4: Discovery Service

**Duration:** Sprints 3–4 | **Effort:** 160 man-hours | **Funding** 100 000 CC
...
**Acceptance criteria:** Newly published packages are searchable within the indexing interval. The Discovery API returns relevant results for keyword, category, and author queries. The registry continues to function normally if the Discovery service is unavailable.

---

## Milestone 5: Web Frontend

**Duration:** Sprint 4 | **Effort:** 200 man-hours | **Funding** 120 000 CC
...
**Acceptance criteria:** Users can discover packages via search and browse, view full package details including README and dependency information, and copy install commands directly from the web interface.

---

## Milestone 6: Integration Testing, Stabilization & Documentation

**Duration:** Sprint 5 | **Effort:** 180 man-hours | **Funding** 110 000 CC 
...
**Acceptance criteria:** All end-to-end scenarios pass. CLI provides clear error messages for all failure modes. Documentation covers all user-facing commands and workflows.

---

## Milestone Summary

| Milestone | Description | Effort | Funding |
| --- | --- | --- | --- |
