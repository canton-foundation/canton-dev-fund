...
**Indicative delivery window:** 12 weeks, subject to validation of DA Registry interfaces and confirmation of the final implementation scope
...
The grant funded public good outputs, being the ERC-7518 Canton Compatibility Profile, the Canton integration adapters and reference implementation, and the associated Canton integration SDK components, Canton conformance tests and technical documentation, will be released under Apache-2.0, subject to legal and ecosystem review. Zoniqx will continue operating the hosted zConnect platform commercially.
...
ERC-7518 is defined for Solidity and the EVM account model. Canton uses Daml contracts, privacy aware multiparty workflows and the Canton Token Standard. The project will map ERC-7518 semantics directly to Canton native contracts and workflows.
...
| E. Canton integration SDK, documentation and conformance tests | Canton specific SDK components, reference code, technical documentation and automated tests enabling other Canton ecosystem participants to understand and reproduce the integration pattern |
...
| Multiparty workflows | Issuer, distributor, investor and registry participate in origination, subscription, allocation and settlement with their respective visibility |
...
### 5. Open Source and Proprietary Scope

| Component | Grant funded public output | Zoniqx proprietary scope |
| --- | --- | --- |
| ERC-7518 Canton Compatibility Profile | Published under Apache-2.0 | — |
| DA Registry integration adapters and Canton reference implementation | Reusable Canton interfaces and reference code published under Apache-2.0, subject to applicable DA interface and licensing requirements | Production configuration and managed deployment |
| Canton integration SDK, conformance tests and technical documentation | Canton specific SDK components, tests, deployment guidance and technical documentation published under Apache-2.0 | — |
| Hosted zConnect platform | — | Commercial application, deal room interfaces and operational services |
| Issuer and investor network | — | Relationships, data and commercial engagement |
| Implementation and onboarding services | — | Commercial support beyond the grant deliverables |

---

## Milestones and Deliverables

Each funded milestone has objective technical outputs within Zoniqx's delivery control, with objective acceptance criteria. Post launch commercial adoption is measured separately and is set out after Milestone 4. The week ranges below are indicative planning estimates and will be finalized following technical validation.
...
- Canton integration SDK and API documentation
- Deployment guide
...
- The Canton integration SDK and documentation enable a third party to reproduce the integration
- Critical security or architecture findings are resolved or documented with an approved remediation plan

> **Adoption evidence.** Zoniqx has received a non binding expression of interest from a prospective institutional design partner relevant to the proposed Canton integration. Subject to the counterparty's authorization and confidentiality requirements, supporting evidence can be shared privately with the Tech & Ops Committee. This expression of interest provides evidence of market demand and does not constitute a deployment, transaction volume or commercial commitment.
...
- **Reproducibility.** The Canton integration SDK and documentation enable a third party to reproduce the integration
...
| Milestone | Amount | Main workstreams | Payment trigger |
| --- | ---: | --- | --- |
| M1 — Architecture and Compatibility Validation | 50,000 CC | DA Registry capability assessment, ERC-7518 mapping, architecture, privacy and security design and implementation planning | Committee acceptance |
| M2 — ERC-7518 Compatibility and End to End Proof of Concept | 62,500 CC | Compatibility profile, Registry and compliance adapters, representative test instrument, integration workflow and automated testing | Committee acceptance |
| M3 — Testnet Release and External Validation | 75,000 CC | Testnet integration, issuer and investor workflows, Canton integration SDK and API documentation, monitoring, conformance testing and external validation | Committee acceptance |
| M4 — Production Readiness and Mainnet Deployment | 62,500 CC | Production hardening, security remediation, deployment configuration, operational runbooks, open source release and maintenance handover | Final release and committee acceptance |

The allocations reflect the current implementation assumptions and will be confirmed after validation of the applicable DA Registry interfaces and final technical scope.

The first payment becomes due upon committee acceptance of Milestone 1.

### Volatility Stipulation

The current planning assumption is 12 weeks and remains subject to technical validation. Should Committee requested scope changes or validated technical requirements extend the project beyond six months, remaining milestones will be renegotiated per Development Fund volatility policy.
...
- A developer workshop or reference walkthrough for Canton builders integrating against the published Canton integration SDK
...
### Representative ERC-7518 Use Cases on Canton

| Use case | Potential users | Value of ERC-7518 compatibility |
| --- | --- | --- |
| Private credit and receivables instruments | Private credit issuers, receivables platforms and institutional investors | Maps share classes, investor eligibility and transfer restrictions into Canton native workflows while using DA Registry for authoritative holdings and settlement |
| Regulated tokenized funds | Fund managers, administrators and tokenization platforms | Provides a common representation for fund classes, transfer controls, locks, recovery and lifecycle events across EVM and Canton environments |
| EVM originated regulated instruments expanding to Canton | Issuers and platforms already using ERC-7518 concepts | Gives technical teams a documented compatibility path for representing regulated asset semantics through Canton contracts and workflows |

These are representative use cases rather than confirmed issuer commitments.

This proposal addresses both. It ensures that assets introduced through Zoniqx remain interoperable with Canton wallets, custodians, registries and applications, and it publishes the Canton integration pattern, Canton integration SDK, conformance tests and compatibility profile so other Canton ecosystem participants can understand and reproduce it.
