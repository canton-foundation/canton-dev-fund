...
| RFP / Roadmap Area | Security, Assurance & Incident Readiness. RFP 25, Identity and Access Control (rfp-25:identity-access-control). Secondary: RFP 27, Security Monitoring, Auditability and Evidence. |
...
| Total Funding Request | 1,550,000 CC |
...
| M2 | Security, Observability, Hardening and Policy Fuzzer | 400,000 | Committee acceptance of criteria 6–12. Running on Upflam's MainNet validator |
...
| M2 | 400 | Audit log, threat model, fuzzer and corpus, observability, load and performance testing, MainNet rollout |
